          ...
          return (
            <button
              ...
              style={{
                ...
                background: iReacted ? 'rgba(var(--accent-rgb),0.2)' : 'rgba(42,45,56,0.6)',
                color: iReacted ? 'var(--accent)' : '#9da3b0',
  ...
  function renderReplyPreview(msg) {
    ...
    return (
      <div style={{
        ...
        <span style={{ fontWeight: '600', color: 'var(--accent)', fontSize: '10px' }}>{originalName}</span>
                      ...
                      {isAdmin && !isMine && (
                        <>
                          ...
                          <button
                            ...
                            style={{
                              background: 'none', border: 'none', padding: '2px 4px',
                              fontSize: '11px', color: mutedUsers[msg.user_id] ? 'var(--accent-soft)' : '#e74c3c',
                            ...
                            {REACTION_EMOJIS.map(emoji => {
                              ...
                              return (
                                <button
                                  ...
                                  onClick={() => toggleReaction(msg.id, emoji)}
                                  style={{
                                    background: iReacted ? 'rgba(var(--accent-rgb),0.2)' : 'transparent',
                                    border: 'none',
                                    borderRadius: '8px',
                                    padding: '4px 8px',
                                    fontSize: '18px',
      ...
      {replyTo && canPost && (
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ fontWeight: '600', color: 'var(--accent)', fontSize: '10px', marginBottom: '1px' }}>
        ...
        <div style={{
          ...
          <button
            ...
            style={{
              ...
              borderRadius: '50%',
              border: 'none',
              background: newMessage.trim() ? (activeTab === 'announcements' ? '#c0a050' : 'var(--accent)') : '#13151c',
