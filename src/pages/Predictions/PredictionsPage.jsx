        ...
        knockoutDeadline.expired ? (
          ...
          <div style={{
            ...
            <div style={{ fontSize: '11px', color: 'var(--text-muted)', lineHeight: '1.5' }}>
              Cierre <span style={{ color: 'var(--gold)', fontWeight: '600' }}>único</span> de los 16 dieciseisavos: <span style={{ color: 'var(--gold)', fontWeight: '600' }}>domingo 20:55</span> (5 min antes del primero)
            </div>
          </div>
        )
      ) : demoMode ? (
