        ...
        <div onClick={() => navigate('/predictions')} role="button" tabIndex={0}
          ...
          <div style={{ flex: 1, minWidth: 0 }}>
            ...
            <div style={{ fontSize: '11px', color: 'rgba(255,255,255,0.7)', lineHeight: '1.4' }}>
              Cuadro real abierto · cierra <strong>dom 20:30</strong> · faltan {knockoutCd.days > 0 ? `${knockoutCd.days}d ` : ''}{String(knockoutCd.hours).padStart(2, '0')}h {String(knockoutCd.minutes).padStart(2, '0')}m
            </div>
          </div>
