      ...
      <div style={{ marginBottom: '14px' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '12px' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
            {/* Engranaje Admin — solo admins. Vive aquí (cabecera de Inicio)
                para que la barra inferior sea idéntica para todos. */}
            {profile?.is_admin && (
              <button
        ...
        <div onClick={() => navigate('/predictions')} role="button" tabIndex={0}
          ...
          <div style={{ flex: 1, minWidth: 0 }}>
            ...
            <div style={{ fontSize: '11px', color: 'rgba(255,255,255,0.7)', lineHeight: '1.4' }}>
              Reabierto · los 15 que faltan · cierra <strong>hoy 18:00</strong> · faltan {knockoutCd.days > 0 ? `${knockoutCd.days}d ` : ''}{String(knockoutCd.hours).padStart(2, '0')}h {String(knockoutCd.minutes).padStart(2, '0')}m
            </div>
          </div>
