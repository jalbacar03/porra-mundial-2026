...
const SOURCE_COLORS = {
  ...
  semi_finalists: { bg: 'rgba(var(--accent-rgb),0.10)', border: 'var(--green)', text: 'var(--green)' },
  quarter_finalists: { bg: 'rgba(var(--accent-rgb),0.08)', border: 'rgba(var(--accent-rgb),0.4)', text: 'var(--green)' },
  round_of_16: { bg: 'rgba(var(--accent-rgb),0.05)', border: 'rgba(var(--accent-rgb),0.3)', text: 'var(--green)' }
}
