"""Cupón Canadá - Bosnia y Herzegovina (hoy) con 1X2 + TODOS los marcadores. -> PNG."""
import os, cairosvg
...
SCORES = [('1-1',29),('2-1',25),('2-0',19),('1-0',14),('1-2',8),('0-1',6),
          ('2-2',6),('3-1',6),('0-0',4),('0-2',1),('3-0',1),('3-2',1)]
...
p.append('<text x="24" y="56" font-family="Helvetica, Arial, sans-serif" font-size="11" fill="#8a8f99">3er partido · Grupo B · 120 predicciones</text>')
...
p.append('<text x="24" y="108" font-family="Helvetica, Arial, sans-serif" font-size="18" font-weight="700" fill="#ffffff">Canadá <tspan fill="#5f636e" font-size="14">vs</tspan> Bosnia</text>')
p.append('<text x="24" y="127" font-family="Helvetica, Arial, sans-serif" font-size="11" fill="#8a8f99">Hoy, 21:00 h · Grupo B</text>')

# 1X2
boxes = [('1 · CANADÁ','55%','66 votos',True),('X · EMPATE','33%','39 votos',False),('2 · BOSNIA','13%','15 votos',False)]
xs = [24,138,252]
...
p.append(f'<text x="190" y="{H-12}" font-family="Helvetica, Arial, sans-serif" font-size="10" fill="#5f636e" text-anchor="middle">porra-mundial-2026 · 12 marcadores distintos · 1 de cada 2 ve ganar a Canadá</text>')
p.append('</svg>')

out = os.path.join(DESK, 'partido3_canada_bosnia.png')
