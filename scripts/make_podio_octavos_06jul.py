...
MATCHES = [('POR – ESP','HOY 21:00'), ('USA – BEL','MAR 02:00')]
# (pos, nombre, pts, color, [(pred, quien_pasa|None), ...])
TOP = [
  (1,'Jan Alemany',122,GOLD,[('1-2',None),('0-1',None)]),
  (2,'Javi Albácar',120,SILVER,[('0-0','POR'),('2-1',None)]),
  (3,'Tomás Brillas',117,BRONZE,[('1-2',None),('1-2',None)]),
  (4,'Nacho de Oza',117,PRIZE,[('2-2','ESP'),('2-1',None)]),
  (5,'Gonzalo Gramunt',114,PRIZE,[('1-2',None),('1-1','USA')]),
]
...
out=os.path.join(DESK,'podio_octavos_06jul.png'); img.save(out); print('->',out)
