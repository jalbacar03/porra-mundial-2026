"""Cupón Qatar - Suiza con 1X2 + TODOS los marcadores. -> PNG."""
import os, cairosvg
...
SCORES = [('0-2',59),('0-3',23),('1-3',12),('1-2',10),('0-1',5),
          ('0-4',4),('1-1',4),('1-4',2),('1-0',1)]
...
p.append('<text x="24" y="56" font-family="Helvetica, Arial, sans-serif" font-size="11" fill="#8a8f99">5º partido · Grupo B · 120 predicciones</text>')
...
p.append('<text x="24" y="108" font-family="Helvetica, Arial, sans-serif" font-size="18" font-weight="700" fill="#ffffff">Qatar <tspan fill="#5f636e" font-size="14">vs</tspan> Suiza</text>')
p.append('<text x="24" y="127" font-family="Helvetica, Arial, sans-serif" font-size="11" fill="#8a8f99">Hoy, 21:00 h · San Francisco</text>')

# 1X2
boxes = [('1 · QATAR','1%','1 voto',False),('X · EMPATE','3%','4 votos',False),('2 · SUIZA','96%','115 votos',True)]
xs = [24,138,252]
...
p.append(f'<text x="190" y="{H-12}" font-family="Helvetica, Arial, sans-serif" font-size="10" fill="#5f636e" text-anchor="middle">porra-mundial-2026 · el más claro: solo 1 ve ganar a Qatar</text>')
p.append('</svg>')

out = os.path.join(DESK, 'partido5_qatar_suiza.png')
