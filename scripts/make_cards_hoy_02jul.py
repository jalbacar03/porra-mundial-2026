"""Cards dieciseisavos 2 jul (mismo formato): todos los marcadores + quién pasa + cuadro ciego + decepción/revelación."""
import os
...
CARDS = [
  {'file':'hoy02_espana_austria.png','hora':'HOY 21:00','home':'España','away':'Austria','total':118,
   'x1':[('1 · ESPAÑA',98,'116',True),('X · EMPATE',2,'2',False),('2 · AUSTRIA',0,'0',False)],
   'scores':[('2-0',58),('3-0',25),('3-1',11),('2-1',10),('1-0',10),('0-0',1),('4-1',1),('4-0',1),('1-1',1)],
   'adv':('España',117,'Austria',1),'cc':('España',121,'Austria',2),
   'special':[]},
  {'file':'hoy02_portugal_croacia.png','hora':'HOY 03:00','home':'Portugal','away':'Croacia','total':118,
   'x1':[('1 · PORTUGAL',69,'81',True),('X · EMPATE',29,'34',False),('2 · CROACIA',3,'3',False)],
   'scores':[('2-1',49),('1-1',24),('1-0',12),('2-0',10),('3-1',7),('2-2',7),('3-2',3),('1-2',3),('0-0',2),('3-3',1)],
   'adv':('Portugal',106,'Croacia',12),'cc':('Portugal',120,'Croacia',37),
   'special':[('DECEPCIÓN','Portugal: 2 la eligieron como decepción','+3 si cae hoy'),('REVELACIÓN','Croacia: 1 la eligió como revelación','+3 si llega a cuartos')]},
  {'file':'hoy02_suiza_argelia.png','hora':'HOY 05:00','home':'Suiza','away':'Argelia','total':118,
   'x1':[('1 · SUIZA',74,'87',True),('X · EMPATE',19,'22',False),('2 · ARGELIA',8,'9',False)],
   'scores':[('2-1',34),('1-0',30),('1-1',17),('2-0',16),('1-2',5),('0-0',3),('0-1',3),('3-1',3),('3-0',3),('2-2',2),('3-2',1),('2-3',1)],
   'adv':('Suiza',102,'Argelia',16),'cc':('Suiza',100,'Argelia',1),
   'special':[('REVELACIÓN','Suiza: 2 la eligieron como revelación','+3 si llega a cuartos')]},
]
