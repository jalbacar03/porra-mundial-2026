"""Cupón Estados Unidos - Paraguay con 1X2 + TODOS los marcadores. -> PNG."""
import os, cairosvg
...
SCORES = [('2-1',41),('1-1',33),('2-0',16),('1-0',9),('2-2',7),('1-2',5),
          ('3-1',3),('0-0',2),('0-1',1),('1-3',1),('3-0',1),('3-2',1)]
...
p.append('<text x="24" y="56" font-family="Helvetica, Arial, sans-serif" font-size="11" fill="#8a8f99">4º partido · Grupo D · 120 predicciones</text>')
...
p.append('<text x="24" y="108" font-family="Helvetica, Arial, sans-serif" font-size="18" font-weight="700" fill="#ffffff">EE.UU. <tspan fill="#5f636e" font-size="14">vs</tspan> Paraguay</text>')
p.append('<text x="24" y="127" font-family="Helvetica, Arial, sans-serif" font-size="11" fill="#8a8f99">Esta noche, 03:00 h · Los Ángeles</text>')

# 1X2
boxes = [('1 · EE.UU.','59%','71 votos',True),('X · EMPATE','35%','42 votos',False),('2 · PARAGUAY','6%','7 votos',False)]
xs = [24,138,252]
...
p.append(f'<text x="190" y="{H-12}" font-family="Helvetica, Arial, sans-serif" font-size="10" fill="#5f636e" text-anchor="middle">porra-mundial-2026 · 12 marcadores distintos · solo 7 ven ganar a Paraguay</text>')
p.append('</svg>')

out = os.path.join(DESK, 'partido4_usa_paraguay.png')
