"""Cards octavos 6 jul (mismo look): todos los marcadores + quién pasa a cuartos + cuadro ciego r16 + revelación."""
import os
...
CARDS = [
  {'file':'oct06_portugal_espana.png','hora':'HOY 21:00','home':'Portugal','away':'España','total':107,
   'x1':[('1 · PORTUGAL',3,'3',False),('X · EMPATE',21,'22',False),('2 · ESPAÑA',77,'82',True)],
   'scores':[('1-2',35),('0-2',21),('1-3',15),('1-1',13),('0-1',9),('2-2',7),('2-1',3),('3-3',1),('0-4',1),('2-3',1),('0-0',1)],
   'adv':('Portugal',5,'España',102),'cc':('Portugal',116,'España',121),
   'special':[]},
  {'file':'oct06_eeuu_belgica.png','hora':'MAR 02:00','home':'EE.UU.','away':'Bélgica','total':107,
   'x1':[('1 · EE.UU.',37,'40',False),('X · EMPATE',39,'42',True),('2 · BÉLGICA',23,'25',False)],
   'scores':[('1-1',37),('2-1',28),('1-2',16),('0-1',7),('2-0',7),('2-2',4),('1-0',4),('3-2',1),('0-2',1),('0-0',1),('1-3',1)],
   'adv':('EE.UU.',67,'Bélgica',40),'cc':('EE.UU.',9,'Bélgica',71),
   'special':[('REVELACIÓN','Estados Unidos: 3 la eligieron como revelación','+3 si llega a cuartos')]},
]
